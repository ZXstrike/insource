...
class _LikedContentListState extends State<LikedContentList> {
  late final LikedListViewProvider listProvider;

  @override
  void initState() {
    super.initState();

    listProvider = Provider.of<LikedListViewProvider>(context, listen: false);
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<LikedListViewProvider>(builder: (context, value, child) {
      debugPrint(value.contentList.toString());
